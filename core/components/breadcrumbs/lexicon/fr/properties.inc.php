 ...
 * @language fr
 */
$_lang['breadcrumbs.prop_desc.maxCrumbs'] = 'Nombre maximun de liens dans le fil d\'ariane. Si vous réduisez le nombre à, disons 5, et que la page vue est à 5 niveaux de profondeur, le fil d\'ariane sera : Accueil > ... > Niveau 4 > Niveau 5. "Accueil" et la page courante ne sont pas comptés et sont configurés séparément..';
...
$_lang['breadcrumbs.prop_desc.respectHidemenu'] = 'Masquer les ressources qui sont masqués dans les menu?';
$_lang['breadcrumbs.prop_desc.showHomeCrumb'] = 'Afficher la page d\'accueil dans le fil d\'ariane ? Ceci n\'est pas toujours nécessaire car un lien vers l\'accueil est habituellement disponible dans la navigation ou en cliquant sur le logo du site.';
...
$_lang['breadcrumbs.prop_desc.crumbSeparator'] = 'Séparateur';
...
$_lang['breadcrumbs.prop_desc.titleField'] = 'Champs de la ressource à utiliser pour le titre des liens. Valeur par défaut : pagetitle.';
$_lang['breadcrumbs.prop_desc.descField'] = 'Champs de la ressource à utiliser pour la description des liens. Valeur par défaut : description (si vide, pagetitle sera utilisé).';
...
$_lang['breadcrumbs.prop_desc.bcTplCrumbFirst'] = '';
$_lang['breadcrumbs.prop_desc.bcTplCrumbHome'] = '';
$_lang['breadcrumbs.prop_desc.bcTplCrumbLast'] = '';
